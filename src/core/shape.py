...
# A quadrilateral figure is an object which has 4 point ids and 4 line ids, these are the ids of the drawn figures in a canvas (graph).
...
def detect_dragging_quadrilateral(point, quadrilaterals, quadrilateral_figures, point_size=15):
  ...
  Returns: The quadrilateral object and quadrilateral figure object which is detected with the point and the corner point which the point is in range from. Or none if none is detected.
  """
